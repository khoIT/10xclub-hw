...
def loadData():
    ...
    for file_name in os.listdir(spec_dir):
        ...
        table_spec_list[file_name] = createTableSpec(file_name, spec_list)
    ...
    for file_name in os.listdir(data_dir):
        ...
        if spec_file_name not in table_spec_list:
            print ("Couldn't find format file for {}".format(file_path))
            continue
        data_file = parseDataFile(file_path, table_spec_list[spec_file_name])
